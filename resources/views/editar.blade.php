...
@section('title')
	<title>Music Planet - Editar perfil</title>
@endsection
...
<div class="row">
	<div class="col-md-6">	
	<form class="" method="POST" action="{{ action('PerfilController@confirmar', ['id' => $user->id]) }}">
		...
		<div class="form-group">
		<label>Pais: </label><br>
	<!--	<input type="text" name="pais" class="form-control" value ="{{$user->pais}}" >-->
...
<select class="form-control input-sm" id="pais" name="pais" value ="{{$user->pais}}" >


<option value="{{$user->pais}}" selected> {{$user->pais}}</option>
